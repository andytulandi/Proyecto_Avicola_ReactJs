    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 font-['Inter'] relative p-4">
      ...
      {step === 1 && (
        <>
          ...
          <Link to="/" className="absolute bottom-8 left-10 bg-[#5be830] hover:bg-[#4dd325] text-black font-bold px-10 py-2 rounded-full shadow-md transition-all active:scale-95 z-10">SALIR</Link>
        </>
      )}
      ...
      {(step === 2 || step === 3) && (
        <>
          ...
          <Link to="/" className="fixed bottom-8 left-8 bg-[#22c55e] hover:bg-[#16a34a] text-white font-bold px-10 py-3 rounded-full shadow-xl transition-all z-10">SALIR</Link>
        </>
      )}
