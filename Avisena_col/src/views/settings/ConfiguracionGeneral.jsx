      ...
      <main className="w-full min-h-screen pb-24 md:pb-lg">
        ...
        <div className="w-full mx-auto px-md md:px-lg py-lg">
          ...
          <div className="grid grid-cols-1 gap-lg">
            ...
            <section className="bg-surface-container-lowest dark:bg-inverse-surface/30 border border-outline-variant rounded-xl p-lg transition-colors">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-md">
                {/* Light Theme Option */}
                <div 
                  className={`theme-selector cursor-pointer group relative overflow-hidden rounded-lg border-2 p-2 transition-all hover:shadow-md ${
                    theme === 'light' 
                ...
                >
                  <div className="h-24 w-full bg-surface-container-low dark:bg-neutral-800 rounded-md mb-2 flex flex-col p-2 gap-1">
                ...
                >
                  <div className="h-24 w-full bg-on-surface-variant dark:bg-neutral-900 rounded-md mb-2 flex flex-col p-2 gap-1">
                ...
                >
                  <div className="h-24 w-full rounded-md mb-2 flex overflow-hidden">
                    <div className="w-1/2 bg-surface-container-low dark:bg-neutral-800 h-full flex flex-col p-2 gap-1">
                      <div className="h-2 w-3/4 bg-outline-variant rounded"></div>
                      <div className="h-8 w-full bg-white dark:bg-neutral-700 border border-outline-variant dark:border-neutral-600 rounded"></div>
                    </div>
                    <div className="w-1/2 bg-on-surface-variant dark:bg-neutral-900 h-full flex flex-col p-2 gap-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-lg">
              ...
              {/* IDIOMA */}
              <section className="bg-surface-container-lowest dark:bg-inverse-surface/30 border border-outline-variant rounded-xl p-lg flex flex-col transition-colors">
                <div className="flex items-center gap-sm mb-lg">
